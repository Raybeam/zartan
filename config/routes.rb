...
Rails.application.routes.draw do
  ...
  constraints site_name: %r{[a-z0-9_.-]+} do
    ...
    get  'v2/:site_name',                     to: 'api/version2#get_proxy'
    post 'v2/:site_name/:proxy_id/succeeded', to: 'api/version2#report_result', succeeded: true
    post 'v2/:site_name/:proxy_id/failed',    to: 'api/version2#report_result', succeeded: false
  end
